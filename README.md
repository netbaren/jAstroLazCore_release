...
Cette page explique comment télécharger, installer et lancer jAstroLazCore sous Windows.
(Aucun outil de développement n’est nécessaire.)
...
La page affiche la dernière version disponible.
Sur cette page GitHub, n’utilisez absolument pas le bouton vert `Code`.
Ce bouton ne correspond pas au paquet Windows de l’application.

Pour télécharger le programme, utilisez la page `Releases` (qui vient normalement d'être ouverte)
puis récupérez le fichier Windows situé dans la section `Assets`.
...
Après le téléchargement, double-cliquez sur ce fichier. 
L’installation démarre automatiquement et crée le dossier de l'application ainsi que le raccourci
comme habituellement avec Windows.
...
1. Créez un dossier, par exemple `C:\jAstroLaz`.
2. Décompressez l’archive avec `Extraire tout...`.
3. Lancez l’application en double-cliquant sur son fichier `.exe`.
...
Pour toute question, voir [CONTACT.md](CONTACT.md).
