...
This guide is for installing the Windows version from the public GitHub page.
...
2. Right-click the downloaded `jAstroLaz-win64-xxxxxxx.zip` file.
3. Choose `Extract All...`.
4. Confirm the proposed folder.
...
Windows may display a warning the first time the program is started because the
application is not signed with a commercial certificate.
